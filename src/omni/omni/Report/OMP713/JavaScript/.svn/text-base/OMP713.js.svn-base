...
function SIRCD_Search(e, str,strmode) {
    ...
    var elmNo2;
	if (strmode == 'FROM'){
	    var elmNo = getElmNo('btnSIRCDFROM1' + str);
	    var elmNo2 = getElmNo('SIRCDFROM1' + str);
	}else{
	    var elmNo = getElmNo('btnSIRCDTO1' + str);
	    var elmNo2 = getElmNo('SIRCDTO1' + str);
	}
	hidstrFocusSet(elmNo, elmNo2, '0');
	...
	if (retval != null) {
	    if (str == "FROM2") {
	        if (btnAJOne('btnAJSIRNMRFROM1') == false) {
	            elm.focus();
	        }
	    } else {
	        if (btnAJOne('btnAJSIRNMRTO1') == false) {
	            elm.focus();
	        }
	    }
	} else {
