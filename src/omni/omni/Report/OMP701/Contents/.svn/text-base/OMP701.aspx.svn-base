<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMP701.aspx.vb" Inherits="omni.OMP7011" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
	<asp:Content ID="mainOMP701" ContentPlaceHolderID="Main" runat="server" >
        <div id="pageContent" >
			...
			<ContentTemplate>
				<div class="divKey" >
					...
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltOUTYYMM" CssClass="redTi lbltOUTYYMM" runat="server" Text="出力年月"></asp:Label>
						<asp:TextBox ID="OUTYYMM" runat="server" Maxlength="7" 
                            onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" 
                            CssClass="OUTYYMM" ></asp:TextBox>
						<asp:Label ID="lbltOUTKBN" CssClass="blackTi lbltOUTKBN" runat="server" Text="出力区分"></asp:Label>
						<asp:DropDownList ID="OUTKBN" runat="server" onFocus="getFocus(this, 0)" onKeyDown="PushEnter(this)" onBlur="relFocus(this)" CssClass="OUTKBN"></asp:DropDownList>
...
<asp:Content ID="Contenthead" runat="server" contentplaceholderid="head">
    <link href="../css/OMP701.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMP701.js" type="text/javascript" ></script>
