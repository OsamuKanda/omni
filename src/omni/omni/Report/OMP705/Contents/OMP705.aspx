<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMP705.aspx.vb" Inherits="omni.OMP7051" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
	<asp:Content ID="mainOMP705" ContentPlaceHolderID="Main" runat="server" >
        <div id="pageContent" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						...
						<asp:Label ID="lbltOUTYYMM" CssClass="blackTi lbltOUTYYMM" runat="server" Text="出力年月"></asp:Label>
						<asp:Label ID="OUTYYMM" runat="server" Text=" " CssClass="lblAJCon OUTYYMM"></asp:Label>
						...
						<asp:Label ID="lbltSAGYOKBN" CssClass="blackTi lbltSAGYOKBN" runat="server" Text="作業分類区分"></asp:Label>
						...
						<asp:Label ID="lbltOUTKBN1" CssClass="redTi lbltOUTKBN1" runat="server" Text="出力指定１"></asp:Label>
						<asp:DropDownList ID="OUTKBN1" runat="server" onFocus="getFocus(this, 0)" onKeyDown="PushEnter(this)" onBlur="relFocus(this)" CssClass="OUTKBN1" ></asp:DropDownList>
						<asp:Label ID="lbltOUTKBN2" CssClass="redTi lbltOUTKBN2" runat="server" Text="出力指定２"></asp:Label>
						<asp:DropDownList ID="OUTKBN2" runat="server" onFocus="getFocus(this, 0)" onKeyDown="PushEnter(this)" onBlur="relFocus(this)" CssClass="OUTKBN2"></asp:DropDownList>
					</asp:Panel>
				</div>
				<hr />
...
<asp:Content ID="Contenthead" runat="server" contentplaceholderid="head">
    <link href="../css/OMP705.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMP705.js" type="text/javascript" ></script>
