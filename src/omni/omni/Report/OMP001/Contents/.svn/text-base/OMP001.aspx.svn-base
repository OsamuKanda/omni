<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMP001.aspx.vb" Inherits="omni.OMP0011" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
	<asp:Content ID="mainOMP001" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
			...
			<ContentTemplate>
				<div class="divKey" >
					...
					<asp:Panel ID="pnlKey" runat="server" >
						...
						<asp:Label ID="lbltOUTJUN" CssClass="blackTi lbltOUTJUN" runat="server" Text="出力順"></asp:Label>
						<asp:DropDownList ID="OUTJUN" runat="server" onFocus="getFocus(this, 0)" onKeyDown="PushEnter(this)" onBlur="relFocus(this)" CssClass="OUTJUN"></asp:DropDownList>
						...
						<asp:Label ID="lbltNONYUCDFROM1" CssClass="blackTi lbltNONYUCDFROM1" runat="server" Text="納入先コード"></asp:Label>
						<asp:TextBox ID="NONYUCDFROM1" runat="server" Maxlength="5" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="NONYUCDFROM1" ></asp:TextBox>
						<asp:Label ID="lbl1" runat="server" Text="～" CssClass="lbl1"></asp:Label>
						<asp:TextBox ID="NONYUCDTO1" runat="server" Maxlength="5" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="NONYUCDTO1" ></asp:TextBox>
...
<link href="../css/OMP001.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMP001.js" type="text/javascript" ></script>
