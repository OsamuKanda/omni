...
function SAGYOUTANTCD_Search(e, str,strmode) {
	...
	var FIELD = "";
	if (strmode == 'FROM'){
	    FIELD = 'SAGYOUTANTCDFROM1';
	}else{
	    FIELD = 'SAGYOUTANTCDTO1';
	}
	...
	if (strmode == 'FROM'){
	    ...
	    var elmNo2 = getElmNo('SAGYOUTANTCDFROM1' + str);
	}else{
	    var elmNo = getElmNo('btnSAGYOUTANTCDTO1' + str);
	    var elmNo2 = getElmNo('SAGYOUTANTCDTO1' + str);
	}
	hidstrFocusSet(elmNo, elmNo2, '0');
	...
	if (retval != null) {
	    if (str == "FROM2") {
	        if (btnAJOne('btnAJSAGYOTANTNMFROM1') == false) {
	            elm.focus();
	        }
	    } else {
	        if (btnAJOne('btnAJSAGYOTANTNMTO1') == false) {
	            elm.focus();
	        }
	    }
	} else {
