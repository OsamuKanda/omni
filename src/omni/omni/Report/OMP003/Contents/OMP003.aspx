<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMP003.aspx.vb" Inherits="omni.OMP0031" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
	<asp:Content ID="mainOMP003" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
			...
			<ContentTemplate>
				<div class="divKey" >
					...
					<asp:Panel ID="pnlKey" runat="server" >
						...
						<asp:Label ID="lbltAREACDFROM1" CssClass="blackTi lbltAREACDFROM1" runat="server" Text="地区コード"></asp:Label>
						<asp:TextBox ID="AREACDFROM1" runat="server" Maxlength="0" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="AREACDFROM1" ></asp:TextBox>
						<asp:Button ID="btnAREACDFROM1" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return AREACDFR_Search(this,'','FROM');" CssClass="btnAREACDFROM1" />
						<asp:UpdatePanel ID="udpAREANMFROM1" runat="server" UpdateMode="Conditional">
							<ContentTemplate>
								<asp:Button ID="btnAJAREANMFROM1" runat="server" TabIndex="-1" Text="AJ" UseSubmitBehavior="False" CssClass="ajaxbtm" />
								<asp:Label ID="AREANMFROM1" runat="server" Text=" " CssClass="lblAJCon AREANMFROM1"></asp:Label>
							</ContentTemplate>
						</asp:UpdatePanel>
						<asp:Label ID="lbl" runat="server" Text="～" CssClass="lbl"></asp:Label>
						<asp:TextBox ID="AREACDTO1" runat="server" Maxlength="0" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="AREACDTO1" ></asp:TextBox>
						<asp:Button ID="btnAREACDTO1" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return AREACDFR_Search(this,'','TO');" CssClass="btnAREACDTO1" />
						<asp:UpdatePanel ID="udpAREANMTO1" runat="server" UpdateMode="Conditional">
							<ContentTemplate>
								<asp:Button ID="btnAJAREANMTO1" runat="server" TabIndex="-1" Text="AJ" UseSubmitBehavior="False" CssClass="ajaxbtm" />
								<asp:Label ID="AREANMTO1" runat="server" Text=" " CssClass="lblAJCon AREANMTO1"></asp:Label>
							</ContentTemplate>
						</asp:UpdatePanel>
					</asp:Panel>
				</div>
...
<link href="../css/OMP003.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMP003.js" type="text/javascript" ></script>
...
<script type="text/javascript" >
	...
	var AJBtn = new Array;
	AJBtn.push(new Array("<%= btnAJAREANMFROM1.ClientID %>", "btnAJAREANMFROM1"));
	AJBtn.push(new Array("<%= btnAJAREANMTO1.ClientID %>", "btnAJAREANMTO1"));
	...
	searchBtn.push(new Array("<%= btnAREACDFROM1.ClientID %>", "btnAREACDFROM1", ""));
	searchBtn.push(new Array("<%= btnAREACDTO1.ClientID %>", "btnAREACDTO1", ""));
</script>
</asp:Content>
