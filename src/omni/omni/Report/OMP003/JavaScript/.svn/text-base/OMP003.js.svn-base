...
function AREACDFR_Search(e, str, strmode) {
    ...
    var elmNo2;
	if (strmode == 'FROM'){
	    var elmNo = getElmNo('btnAREACDFROM1' + str);
	    var elmNo2 = getElmNo('AREACDFROM1' + str);
	}else{
	    var elmNo = getElmNo('btnAREACDTO1' + str);
	    var elmNo2 = getElmNo('AREACDTO1' + str);
	}
	hidstrFocusSet(elmNo, elmNo2, '0');
	...
	if (retval != null) {
	    if (strmode == "FROM") {
	        if (btnAJOne('btnAJAREANMFROM1') == false) {
	            elm.focus();
	        }
	    } else {
	        if (btnAJOne('btnAJAREANMTO1') == false) {
	            elm.focus();
	        }
	    }
	} else {
