<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMP711.aspx.vb" Inherits="omni.OMP7111" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
	<asp:Content ID="mainOMP711" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
			...
			<ContentTemplate>
				<div class="divKey" >
					...
					<asp:Panel ID="pnlKey" runat="server" >
						...
						<asp:Label ID="lbltSAGYOKBNFROM" CssClass="blackTi lbltSAGYOKBNFROM" runat="server" Text="作業分類区分"></asp:Label>
						...
						<asp:TextBox ID="OUTYYMM" runat="server" Maxlength="7" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="OUTYYMM" ></asp:TextBox>
					</asp:Panel>
				</div>
				<hr />
...
<link href="../css/OMP711.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMP711.js" type="text/javascript" ></script>
