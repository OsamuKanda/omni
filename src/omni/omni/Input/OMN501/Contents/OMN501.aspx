<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN501.aspx.vb" Inherits="omni.OMN5011" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN501" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltSAGYOYMD" CssClass="redTi lbltSAGYOYMD" runat="server" Text="作業日"></asp:Label>
								<asp:TextBox ID="SAGYOYMD" runat="server" Maxlength="10" onFocus="getFocus(this, 2)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="SAGYOYMD" ></asp:TextBox>
								<asp:ImageButton ID="btnSAGYOYMD" runat="server" ImageAlign="Middle" ImageUrl="~/img/cal.GIF" AlternateText="カレンダー" OnClientClick="return CLD_show('SAGYOYMD', '',this);" CssClass="btnSAGYOYMD" />
								...
								<asp:Label ID="lblTAITLE1" runat="server" Text="～" CssClass="lblTAITLE1"></asp:Label>
								...
								<asp:TextBox ID="KOSHO" runat="server" Rows="3" TextMode="MultiLine" Maxlength="180" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="KOSHO" ></asp:TextBox>
								<asp:Label ID="lbltGENIN" CssClass="blackTi lbltGENIN" runat="server" Text="原因"></asp:Label>
								<asp:TextBox ID="GENIN" runat="server" Rows="3" TextMode="MultiLine" Maxlength="180" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="GENIN" ></asp:TextBox>
								<asp:Label ID="lbltTAISHO" CssClass="blackTi lbltTAISHO" runat="server" Text="対処"></asp:Label>
								<asp:TextBox ID="TAISHO" runat="server" Rows="3" TextMode="MultiLine" Maxlength="180" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="TAISHO" ></asp:TextBox>
								<asp:Label ID="lbltBUHINKBN" CssClass="redTi lbltBUHINKBN" runat="server" Text="部品更新"></asp:Label>
								<asp:DropDownList ID="BUHINKBN" runat="server" onFocus="getFocus(this, 0)" onKeyDown="PushEnter(this)" onBlur="relFocus(this)" CssClass="BUHINKBN"></asp:DropDownList>
								...
								<asp:TextBox ID="HOZONSAKI" runat="server" Rows="3" TextMode="MultiLine" Maxlength="255" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="HOZONSAKI" ></asp:TextBox>
								<asp:Label ID="lbltMITSUMORINO" CssClass="blackTi lbltMITSUMORINO" runat="server" Text="最終見積番号"></asp:Label>
								<asp:TextBox ID="MITSUMORINO" runat="server" Maxlength="11" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="MITSUMORINO" ></asp:TextBox>
							</asp:Panel>
						</div>
					</ContentTemplate>
				</asp:UpdatePanel>
...
<asp:Content ID="headOMN501" runat="server" contentplaceholderid="head">
<link href="../css/OMN501.css" rel="stylesheet" type="text/css" />
...
<script src="../JavaScript/OMN501.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	AJBtn.push(new Array("<%= btnAJKey.ClientID %>", "btnAJKey"));
	...
	searchBtn.push(new Array("<%= btnSAGYOYMD.ClientID %>", "btnSAGYOYMD", "<%= SAGYOYMD.ClientID %>"));
