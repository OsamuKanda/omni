...
function SHRNO_Search(e, str) {

	var url = "../../../Search/OMN815/Contents/OMN815.aspx";
	var mode = "Search";
	var nWidth = "674px";
	var nHeight = "609px";
	var option = "dialogWidth=" + nWidth + ";dialogHeight=" + nHeight + ";center:1;status:no;scroll:no;resizable:no;";
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnSHRNO' + str);
	var elmNo2 = getElmNo('SHRNO' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
	var elm = getNextFocusElm(elmNo, 'cli');
	var elm2 = getNextFocusElmE(elmNo2, 'cli');
	//modori値の処理
