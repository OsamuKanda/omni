...
function SIRNO_Search(e, str) {

	var url = "../../../Search/OMN814/Contents/OMN814.aspx";
	var mode = "Search";
	var nWidth = "638px";
	var nHeight = "588px";
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnSIRNO' + str);
	var elmNo2 = getElmNo('SIRNO' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
...
function SIRCD_Search(e, str) {
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('BBUNRUICD00');
	...
	e.disabled = false;
	if (retval != null) {
	    if (btnAJOne('btnAJSIRNM1' + str) == false) {
	        elm.focus();
	    }
	} else {
	    elm2.focus();
...
function BKIKAKUCD_Search(e, str, mode2) {
	...
	e.disabled = false;
	if (retval != null) {
	    if (btnAJOne('btnAJBBUNRUINM' + str) == false) {
	        elm.focus();
	    }
	} else {
	    elm2.focus();
