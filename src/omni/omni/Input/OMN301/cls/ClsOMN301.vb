...
Public Class ClsOMN301 : Inherits ClsModel5Base
#Region "変数"
    ''' <summary>
    ''' 受け渡し用データ項目
    ''' </summary>
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private mdao As New OMN301Dao(Of ClsOMN301)
...
#End Region
    ...
    Public Function gBlnGetPTNData(ByVal PTNCD As String) As Boolean
        Return mdao.gBlnGetPTNData(Me, PTNCD)
    End Function
