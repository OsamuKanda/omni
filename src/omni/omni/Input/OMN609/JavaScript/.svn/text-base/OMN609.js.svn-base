...
function getFirstFocus() {
	return document.getElementById(btnMode[2]);
}
...
function btnModeTab(e) {
	...
	if (bshift == false) {
		if (nCode == 9) {
			...
			// TABキーのみの場合
				switch (e.id) {
				case btnMode[0]: elm = document.getElementById(btnMode[0]); break;
				case btnMode[1]: elm = document.getElementById(btnMode[1]); break;
				case btnMode[2]: elm = document.getElementById(btnMode[2]); break;
				default: break;
			}
		}
	} else {
...
function SEIKYUSHONO_Search(e, str) {
    ...
    var url = "../../../Search/OMN824/Contents/OMN824.aspx?MODE=OMN609";
    var mode = "Search";
    var nWidth = "917px";
    var nHeight = "665px";
