...
function setScroll(nNum) {
    if (scrollCHG) {
        ...
        if (nNum == 2) {
            if (scrollElm.scrollHeight > 281) {
                scrollElm.scrollTop = scrollElm.scrollHeight - 279;
            } else {
                scrollElm.scrollTop = scrollVal;
            }
        } else {
            if (scrollElm.scrollHeight > 281) {
                if ((scrollElm.scrollHeight - 280) < scrollVal) {
                    scrollElm.scrollTop = scrollElm.scrollHeight - 279;
                } else {
                    scrollElm.scrollTop = scrollVal;
                }
...
function elementView(bMode) {
	if (bMode) {
		...
		document.getElementById(modeCANGE[4][0]).style.display = '';
		document.getElementById(modeCANGE[5][0]).style.display = '';
	} else {
		...
		document.getElementById(modeCANGE[4][0]).style.display = 'none';
		document.getElementById(modeCANGE[5][0]).style.display = 'none';
	}
}
...
function SIRNO_Search(e, str) {
	...
	var url = "../../../Search/OMN825/Contents/OMN825.aspx";
	var mode = "Search";
	var nWidth = "648px";
	var nHeight = "568px";
