<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN608.aspx.vb" Inherits="omni.OMN6081" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN608" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								...
								<asp:Label ID="lbltTAXKBN" CssClass="blackTi lbltTAXKBN" runat="server" Text="税区分"></asp:Label>
								...
								<asp:Label ID="lbltBUNKATSU" CssClass="redTi lbltBUNKATSU" runat="server" Text="分割回数"></asp:Label>
								<asp:TextBox ID="BUNKATSU" runat="server" Maxlength="2" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="BUNKATSU" ></asp:TextBox>
													...
													<td class="CellTAX" >
														<asp:UpdatePanel ID="udpTAX00" runat="server" UpdateMode="Conditional">
															<ContentTemplate>
																...
																<asp:TextBox ID="TAX00" runat="server" Maxlength="12" 
                                                                    onFocus="getFocus(this, 1)" onKeyDown="PushEnter()" onBlur="relFocus(this)" 
                                                                    CssClass="TANKA00" Visible="False" ></asp:TextBox>
															</ContentTemplate>
														</asp:UpdatePanel>
													</td>
												</tr>
...
<asp:Content ID="headOMN608" runat="server" contentplaceholderid="head">
<link href="../css/OMN608.css" rel="stylesheet" type="text/css" />
...
<script src="../JavaScript/OMN608.js" type="text/javascript" ></script>
