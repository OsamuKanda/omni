...
#Region "プライベートメソッド"
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            .gSubSetRow("SAGYOBKBN","作業分類区分")
            .gSubSetRow("RENNO","連番")
            .gSubSetRow("SAGYOTANTCD1","作業担当者1")
            .gSubSetRow("SAGYOTANTCD2","作業担当者2")
            .gSubSetRow("SAGYOTANTCD3","作業担当者3")
        End With
    End Sub
