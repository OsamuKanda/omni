...
function setScroll(nNum) {
    if (scrollCHG) {
        ...
        if (nNum == 2) {
            if (scrollElm.scrollHeight > 421) {
                scrollElm.scrollTop = scrollElm.scrollHeight - 419;
            } else {
                scrollElm.scrollTop = scrollVal;
            }
        } else {
            if (scrollElm.scrollHeight > 421) {
                if ((scrollElm.scrollHeight - 420) < scrollVal) {
                    scrollElm.scrollTop = scrollElm.scrollHeight - 421;
                } else {
                    scrollElm.scrollTop = scrollVal;
                }
            } else {
