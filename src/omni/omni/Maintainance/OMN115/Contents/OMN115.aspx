<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN115.aspx.vb" Inherits="omni.OMN1151" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN115" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltGENINCD" CssClass="redTi lbltGENINCD" runat="server" Text="原因コード"></asp:Label>
						<asp:TextBox ID="GENINCD" runat="server" Maxlength="4" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="GENINCD" ></asp:TextBox>
						<asp:Button ID="btnGENINCD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return GENINCD_Search(this,'');" CssClass="btnGENINCD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltGENINNAIYO" CssClass="blackTi lbltGENINNAIYO" runat="server" Text="原因内容"></asp:Label>
...
<asp:Content ID="headOMN115" runat="server" contentplaceholderid="head">
<link href="../css/OMN115.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN115.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnGENINCD.ClientID %>", "btnGENINCD", "<%= GENINCD.ClientID %>"));
