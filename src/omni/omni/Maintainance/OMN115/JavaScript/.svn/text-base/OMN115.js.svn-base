...
function GENINCD_Search(e, str) {

	var url = "../../../Search/OMN820/Contents/OMN820.aspx";
	var mode = "Search";
	var nWidth = "739px";
	var nHeight = "567px";
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnGENINCD' + str);
	var elmNo2 = getElmNo('GENINCD' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
