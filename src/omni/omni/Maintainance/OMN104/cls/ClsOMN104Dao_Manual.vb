...
Partial Public Class OMN104Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_GINKO")
            strSQL.Append("(")
            strSQL.Append(" GINKOCD")                                           '銀行コード
            strSQL.Append(",GINKONM")                                           '銀行名称
            ...
            strSQL.Append(ClsDbUtil.get文字列値(.strGINKOCD))                   '銀行コード
            strSQL.Append("," & ClsDbUtil.get文字列値(.strGINKONM))             '銀行名称
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append(" WHERE DM_GINKO.GINKOCD= '" & .strGINKOCD & "'")                           '銀行コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_GINKO")
            strSQL.Append("   SET GINKONM         = " & ClsDbUtil.get文字列値(.strGINKONM))            '銀行名称
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_GINKO.GINKOCD AS GINKOCD ")
            strSQL.Append(", DM_GINKO.GINKONM AS GINKONM ")

            strSQL.Append(", DM_GINKO.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_GINKO.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_GINKO.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_GINKO.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
    ...
    Protected Overrides Sub setTableTo(ByVal dt As System.Data.DataTable, ByVal o As T)
        With o.gcol_H
            Dim r = dt.Rows(0)
            .strGINKOCD = r("GINKOCD").ToString             '銀行コード
            .strGINKONM = r("GINKONM").ToString             '銀行名称
