<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN104.aspx.vb" Inherits="omni.OMN1041" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN104" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltGINKOCD" CssClass="redTi lbltGINKOCD" runat="server" Text="銀行コード"></asp:Label>
						<asp:TextBox ID="GINKOCD" runat="server" Maxlength="3" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="GINKOCD" ></asp:TextBox>
						<asp:Button ID="btnGINKOCD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return GINKOCD_Search(this,'');" CssClass="btnGINKOCD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltGINKONM" CssClass="redTi lbltGINKONM" runat="server" Text="銀行名称"></asp:Label>
...
<asp:Content ID="headOMN104" runat="server" contentplaceholderid="head">
<link href="../css/OMN104.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN104.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnGINKOCD.ClientID %>", "btnGINKOCD", "<%= GINKOCD.ClientID %>"));
