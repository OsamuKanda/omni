...
Partial Public Class OMN106Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_BUNRUIC")
            strSQL.Append("(")
            strSQL.Append(" BUNRUICCD")                                         '中分類コード
            strSQL.Append(",BUNRUICNM")                                         '中分類名
            ...
            strSQL.Append(ClsDbUtil.get文字列値(.strBUNRUICCD))                 '中分類コード
            strSQL.Append("," & ClsDbUtil.get文字列値(.strBUNRUICNM))           '中分類名
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_BUNRUIC")
            ...
            strSQL.Append(" WHERE DM_BUNRUIC.BUNRUICCD= '" & .strBUNRUICCD & "'")                         '中分類コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_BUNRUIC")
            strSQL.Append("   SET BUNRUICNM       = " & ClsDbUtil.get文字列値(.strBUNRUICNM))          '中分類名
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_BUNRUIC.BUNRUICCD AS BUNRUICCD ")
            strSQL.Append(", DM_BUNRUIC.BUNRUICNM AS BUNRUICNM ")

            strSQL.Append(", DM_BUNRUIC.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_BUNRUIC.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_BUNRUIC.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_BUNRUIC.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
    ...
    Protected Overrides Sub setTableTo(ByVal dt As System.Data.DataTable, ByVal o As T)
        With o.gcol_H
            Dim r = dt.Rows(0)
            .strBUNRUICCD = r("BUNRUICCD").ToString         '中分類コード
            .strBUNRUICNM = r("BUNRUICNM").ToString         '中分類名
