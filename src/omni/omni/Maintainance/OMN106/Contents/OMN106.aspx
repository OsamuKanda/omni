<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN106.aspx.vb" Inherits="omni.OMN1061" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN106" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltBUNRUICCD" CssClass="redTi lbltBUNRUICCD" runat="server" Text="中分類コード"></asp:Label>
						<asp:TextBox ID="BUNRUICCD" runat="server" Maxlength="2" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="BUNRUICCD" ></asp:TextBox>
						<asp:Button ID="btnBUNRUICCD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return BUNRUICCD_Search(this,'');" CssClass="btnBUNRUICCD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltBUNRUICNM" CssClass="redTi lbltBUNRUICNM" runat="server" Text="中分類名"></asp:Label>
...
<asp:Content ID="headOMN106" runat="server" contentplaceholderid="head">
<link href="../css/OMN106.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN106.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnBUNRUICCD.ClientID %>", "btnBUNRUICCD", "<%= BUNRUICCD.ClientID %>"));
