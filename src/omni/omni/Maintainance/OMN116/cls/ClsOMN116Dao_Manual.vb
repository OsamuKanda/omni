...
Partial Public Class OMN116Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_TAISHO")
            strSQL.Append("(")
            strSQL.Append(" TAISHOCD")                                          '対処コード
            strSQL.Append(",TAISHONAIYO")                                       '対処内容
            ...
            strSQL.Append(ClsDbUtil.get文字列値(.strTAISHOCD))                  '対処コード
            strSQL.Append("," & ClsDbUtil.get文字列値(.strTAISHONAIYO))         '対処内容
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_TAISHO")
            ...
            strSQL.Append(" WHERE DM_TAISHO.TAISHOCD= '" & .strTAISHOCD & "'")                          '対処コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_TAISHO")
            strSQL.Append("   SET TAISHONAIYO     = " & ClsDbUtil.get文字列値(.strTAISHONAIYO))        '対処内容
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_TAISHO.TAISHOCD AS TAISHOCD ")
            strSQL.Append(", DM_TAISHO.TAISHONAIYO AS TAISHONAIYO ")

            strSQL.Append(", DM_TAISHO.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_TAISHO.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_TAISHO.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_TAISHO.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
            strSQL.Append("  DM_TAISHO ")                                                  'ヘッダ
            strSQL.Append("WHERE DM_TAISHO.TAISHOCD = '" & .strTAISHOCD & "' ")                         '対処コード
            'If o.更新区分 <> em更新区分.新規 Then
            '    strSQL.Append("   AND DM_TAISHO.DELKBN ='0'")
            'End If
    ...
    Protected Overrides Sub setTableTo(ByVal dt As System.Data.DataTable, ByVal o As T)
        With o.gcol_H
            Dim r = dt.Rows(0)
            .strTAISHOCD = r("TAISHOCD").ToString           '対処コード
            .strTAISHONAIYO = r("TAISHONAIYO").ToString     '対処内容
