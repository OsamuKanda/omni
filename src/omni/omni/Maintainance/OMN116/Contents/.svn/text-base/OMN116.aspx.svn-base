<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN116.aspx.vb" Inherits="omni.OMN1161" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN116" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltTAISHOCD" CssClass="redTi lbltTAISHOCD" runat="server" Text="対処コード"></asp:Label>
						<asp:TextBox ID="TAISHOCD" runat="server" Maxlength="4" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="TAISHOCD" ></asp:TextBox>
						<asp:Button ID="btnTAISHOCD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return TAISHOCD_Search(this,'');" CssClass="btnTAISHOCD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltTAISHONAIYO" CssClass="blackTi lbltTAISHONAIYO" runat="server" Text="対処内容"></asp:Label>
...
<asp:Content ID="headOMN116" runat="server" contentplaceholderid="head">
<link href="../css/OMN116.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN116.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnTAISHOCD.ClientID %>", "btnTAISHOCD", ""));
