...
function TAISHOCD_Search(e, str) {

	var url = "../../../Search/OMN821/Contents/OMN821.aspx";
	var mode = "Search";
	var nWidth = "739px";
	var nHeight = "567px";
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnTAISHOCD' + str);
	var elmNo2 = getElmNo('TAISHOCD' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
