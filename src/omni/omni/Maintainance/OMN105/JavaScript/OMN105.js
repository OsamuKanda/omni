...
function BUNRUIDCD_Search(e, str) {

	var url = "../../../Search/OMN816/Contents/OMN816.aspx";
	var mode = "Search";
	var nWidth = "300px";
	var nHeight = "567px";
	...
	if (retval != null) {
		for (i = 0; i < objclient.length; i++) {
			if (objclient[i][1] == "BUNRUIDCD" + str) {
				elm = document.getElementById(objclient[i][0]);
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnBUNRUIDCD' + str);
	var elmNo2 = getElmNo('BUNRUIDCD' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
