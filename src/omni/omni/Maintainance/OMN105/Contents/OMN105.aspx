<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN105.aspx.vb" Inherits="omni.OMN1051" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN105" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltBUNRUIDCD" CssClass="redTi lbltBUNRUIDCD" runat="server" Text="大分類コード"></asp:Label>
						<asp:TextBox ID="BUNRUIDCD" runat="server" Maxlength="2" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="BUNRUIDCD" ></asp:TextBox>
						<asp:Button ID="btnBUNRUIDCD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return BUNRUIDCD_Search(this,'');" CssClass="btnBUNRUIDCD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltBUNRUIDNM" CssClass="redTi lbltBUNRUIDNM" runat="server" Text="大分類名"></asp:Label>
...
<asp:Content ID="headOMN105" runat="server" contentplaceholderid="head">
<link href="../css/OMN105.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN105.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnBUNRUIDCD.ClientID %>", "btnBUNRUIDCD", "<%= BUNRUIDCD.ClientID %>"));
