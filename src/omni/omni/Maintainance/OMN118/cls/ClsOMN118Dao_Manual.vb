...
Partial Public Class OMN118Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_SHUBETSU")
            strSQL.Append("(")
            strSQL.Append(" SHUBETSUCD")                                        '種別コード
            strSQL.Append(",SHUBETSUNM")                                        '種別名
            ...
            strSQL.Append("," & ClsDbUtil.get文字列値(.strSHUBETSUNM))          '種別名
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_SHUBETSU")
            ...
            strSQL.Append(" WHERE DM_SHUBETSU.SHUBETSUCD= '" & .strSHUBETSUCD & "'")                        '種別コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_SHUBETSU")
            strSQL.Append("   SET SHUBETSUNM      = " & ClsDbUtil.get文字列値(.strSHUBETSUNM))         '種別名
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_SHUBETSU.SHUBETSUCD AS SHUBETSUCD ")
            strSQL.Append(", DM_SHUBETSU.SHUBETSUNM AS SHUBETSUNM ")

            strSQL.Append(", DM_SHUBETSU.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_SHUBETSU.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_SHUBETSU.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_SHUBETSU.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
