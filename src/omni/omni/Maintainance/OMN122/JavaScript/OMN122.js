...
function HBUNRUICD_Search(e, str) {

    var url = "../../../Search/OMN826/Contents/OMN826.aspx";
    var mode = "Search";
    var nWidth = "535px";
    var nHeight = "567px";
    ...
    if (retval != null) {
        for (i = 0; i < objclient.length; i++) {
            if (objclient[i][1] == "HBUNRUICD" + str) {
                elm = document.getElementById(objclient[i][0]);
    ...
    // 規定値のフォーカスセット
    var elmNo = getElmNo('btnHBUNRUICD' + str);
    var elmNo2 = getElmNo('HBUNRUICD' + str);
    hidstrFocusSet(elmNo, elmNo2, '0');
