<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN122.aspx.vb" Inherits="omni.OMN1221" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN122" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltHBUNRUICD" CssClass="redTi lbltHBUNRUICD" runat="server" Text="報告書分類コード"></asp:Label>
						<asp:TextBox ID="HBUNRUICD" runat="server" Maxlength="1" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="HBUNRUICD" ></asp:TextBox>
						<asp:Button ID="btnHBUNRUICD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return HBUNRUICD_Search(this,'');" CssClass="btnHBUNRUICD" />
...
<asp:Content ID="headOMN122" runat="server" contentplaceholderid="head">
<link href="../css/OMN122.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN122.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnHBUNRUICD.ClientID %>", "btnHBUNRUICD", "<%= HBUNRUICD.ClientID %>"));
