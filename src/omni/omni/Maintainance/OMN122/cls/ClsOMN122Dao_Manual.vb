...
Partial Public Class OMN122Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_HBUNRUI")
            strSQL.Append("(")
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_HBUNRUI")
            ...
            strSQL.Append(" WHERE DM_HBUNRUI.HBUNRUICD= '" & .strHBUNRUICD & "'")                         '報告書分類コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_HBUNRUI")
            strSQL.Append("   SET HBUNRUINM       = " & ClsDbUtil.get文字列値(.strHBUNRUINM))          '報告書分類名
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_HBUNRUI.HBUNRUICD AS HBUNRUICD ")
            strSQL.Append(", DM_HBUNRUI.HBUNRUINM AS HBUNRUINM ")

            strSQL.Append(", DM_HBUNRUI.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_HBUNRUI.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_HBUNRUI.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_HBUNRUI.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
            strSQL.Append("  DM_HBUNRUI ")                                                  'ヘッダ
            strSQL.Append("WHERE DM_HBUNRUI.HBUNRUICD = '" & .strHBUNRUICD & "' ")                        '報告書分類コード
            'If o.更新区分 <> em更新区分.新規 Then
            '    strSQL.Append("   AND DM_HBUNRUI.DELKBN ='0'")
            'End If
