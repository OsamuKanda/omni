...
#Region "オーバーライドするメソッド"
    ...
    Protected Overrides Sub mSubBtnAJSearch()
        ...
        With mprg.mwebIFDataTable        '検索
            ...
            Else
                '取得可否チェック
                With CType(mprg.gmodel, ClsOMN122).gcol_H
                    If .strDELKBN = "1" Then
                        '削除済み時
                        Select Case mGet更新区分()
                            Case em更新区分.新規
            ...
            '値を退避
            Dim oCopy_H As New ClsOMN122.ClsCol_H
            ClsChkStringUtil.gSubDeepCopy(oCopy_H, CType(mprg.gmodel, ClsOMN122).gcol_H)
            CType(mprg.gmodel, ClsOMN122).gcopy_H = oCopy_H
    ...
    Protected Overrides Sub mSubGetText()
        With CType(mprg.gmodel, ClsOMN122).gcol_H
            .strHBUNRUICD = HBUNRUICD.Text                            '報告書分類コード

            .strHBUNRUINM = HBUNRUINM.Text                            '報告書分類名
    ...
    Protected Overrides Sub mSubSetText()
        With CType(mprg.gmodel, ClsOMN122).gcol_H
            'TODO 個別修正箇所
            HBUNRUICD.Text = .strHBUNRUICD                            '報告書分類コード

            HBUNRUINM.Text = .strHBUNRUINM                            '報告書分類名
    ...
    Protected Overrides Function mBlnChkInput(ByVal arrErrMsg As ClsErrorMessageList) As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN122)
    ...
    Protected Overrides Function mBln表示用にフォーマット() As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN122)
            With .gcol_H
            .strHBUNRUINM = .strHBUNRUINM                                                 '報告書分類名
...
#End Region
    ...
    Protected Overrides Sub mSubCreateWebIFData()
        ...
        With mprg.mwebIFDataTable
            .gSubAdd(HBUNRUICD.ClientID, "HBUNRUICD", 0, "numzero__1_", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(btnHBUNRUICD.ClientID, "btnHBUNRUICD", 0, "", "", "", "", "", "keyElm", "1", "0")
            .gSubAdd(btnSearch.ClientID,"btnSearch", 0, "", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(HBUNRUINM.ClientID,"HBUNRUINM", 0, "!bytecount__60_", "", "", "", "", "mainElm", "1", "1")
