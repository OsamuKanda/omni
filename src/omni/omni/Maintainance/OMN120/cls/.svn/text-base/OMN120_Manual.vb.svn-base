...
#Region "オーバーライドするメソッド"
    ...
    Protected Overrides Sub mSubBtnAJSearch()
        ...
        With mprg.mwebIFDataTable        '検索
            ...
            Else
                '取得可否チェック
                With CType(mprg.gmodel, ClsOMN120).gcol_H
                    If .strDELKBN = "1" Then
                        '削除済み時
                        Select Case mGet更新区分()
                            Case em更新区分.新規
            ...
            '値を退避
            Dim oCopy_H As New ClsOMN120.ClsCol_H
            ClsChkStringUtil.gSubDeepCopy(oCopy_H, CType(mprg.gmodel, ClsOMN120).gcol_H)
            CType(mprg.gmodel, ClsOMN120).gcopy_H = oCopy_H
    ...
    Protected Overrides Sub mSubGetText()
        With CType(mprg.gmodel, ClsOMN120).gcol_H
            .strBUMONCD = BUMONCD.Text                                '部門コード

            .strBUMONNM = BUMONNM.Text                                '部門名
    ...
    Protected Overrides Sub mSubSetText()
        With CType(mprg.gmodel, ClsOMN120).gcol_H
            'TODO 個別修正箇所
            BUMONCD.Text = .strBUMONCD                                '部門コード

            BUMONNM.Text = .strBUMONNM                                '部門名
    ...
    Protected Overrides Function mBlnChkInput(ByVal arrErrMsg As ClsErrorMessageList) As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN120)
...
#End Region
    ...
    Protected Overrides Sub mSubCreateWebIFData()
        ...
        With mprg.mwebIFDataTable
            .gSubAdd(BUMONCD.ClientID,"BUMONCD", 0, "numzero__1_", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(btnBUMONCD.ClientID,"btnBUMONCD", 0, "", "", "", "", "", "keyElm", "1", "0")
            .gSubAdd(btnSearch.ClientID,"btnSearch", 0, "", "", "", "", "", "keyElm", "1", "1")
            '(HIS-059).gSubAdd(BUMONNM.ClientID, "BUMONNM", 0, "bytecount__10_", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(BUMONNM.ClientID, "BUMONNM", 0, "bytecount__20_", "", "", "", "", "mainElm", "1", "1") '(HIS-059)
