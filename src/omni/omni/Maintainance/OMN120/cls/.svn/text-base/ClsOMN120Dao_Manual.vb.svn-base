...
Partial Public Class OMN120Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_BUMON")
            strSQL.Append("(")
            strSQL.Append(" BUMONCD")                                           '部門コード
            strSQL.Append(",BUMONNM")                                           '部門名
            ...
            strSQL.Append("," & ClsDbUtil.get文字列値(.strBUMONNM))             '部門名
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append(" WHERE DM_BUMON.BUMONCD= '" & .strBUMONCD & "'")                           '部門コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_BUMON")
            strSQL.Append("   SET BUMONNM         = " & ClsDbUtil.get文字列値(.strBUMONNM))            '部門名
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_BUMON.BUMONCD AS BUMONCD ")
            strSQL.Append(", DM_BUMON.BUMONNM AS BUMONNM ")

            strSQL.Append(", DM_BUMON.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_BUMON.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_BUMON.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_BUMON.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
            strSQL.Append("  DM_BUMON ")                                                  'ヘッダ
            strSQL.Append("WHERE DM_BUMON.BUMONCD = '" & .strBUMONCD & "' ")                          '部門コード
            'If o.更新区分 <> em更新区分.新規 Then
            '    strSQL.Append("   AND DM_BUMON.DELKBN ='0'")
            'End If
    ...
    Protected Overrides Sub setTableTo(ByVal dt As System.Data.DataTable, ByVal o As T)
        With o.gcol_H
            ...
            .strBUMONNM = r("BUMONNM").ToString             '部門名
