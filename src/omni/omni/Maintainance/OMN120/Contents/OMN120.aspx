<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN120.aspx.vb" Inherits="omni.OMN1201" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN120" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltBUMONCD" CssClass="redTi lbltBUMONCD" runat="server" Text="部門コード"></asp:Label>
						<asp:TextBox ID="BUMONCD" runat="server" Maxlength="1" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="BUMONCD" ></asp:TextBox>
						<asp:Button ID="btnBUMONCD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return BUMONCD_Search(this,'');" CssClass="btnBUMONCD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltBUMONNM" CssClass="redTi lbltBUMONNM" runat="server" Text="部門名"></asp:Label>
								<asp:TextBox ID="BUMONNM" runat="server" Maxlength="20" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="BUMONNM" ></asp:TextBox>
							</asp:Panel>
						</div>
					</ContentTemplate>
				</asp:UpdatePanel>
...
<asp:Content ID="headOMN120" runat="server" contentplaceholderid="head">
<link href="../css/OMN120.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN120.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnBUMONCD.ClientID %>", "btnBUMONCD", "<%= BUMONCD.ClientID %>"));
