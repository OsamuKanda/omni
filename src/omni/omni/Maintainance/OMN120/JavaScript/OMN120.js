...
function BUMONCD_Search(e, str) {

	var url = "../../../Search/OMN819/Contents/OMN819.aspx";
	var mode = "Search";
	var nWidth = "300px";
	var nHeight = "567px";
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnBUMONCD' + str);
	var elmNo2 = getElmNo('BUMONCD' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
