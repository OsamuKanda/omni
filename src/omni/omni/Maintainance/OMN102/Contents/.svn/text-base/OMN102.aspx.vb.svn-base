...
#Region "プライベートメソッド"
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            ...
            .gSubSetRow("JIGYONM","事業所名")
            .gSubSetRow("ZIPCODE","郵便番号")
            .gSubSetRow("ADD1","住所１")
            .gSubSetRow("ADD2","住所２")
            .gSubSetRow("TELNO","電話番号")
            .gSubSetRow("FAXNO","ＦＡＸ番号")
            .gSubSetRow("FURIGINKONM","請求書振込銀行名")
            .gSubSetRow("TOKUGINKONM","請求書特定銀行名")
            .gSubSetRow("BUKKENNO","物件番号")
            .gSubSetRow("SEIKYUSHONO","請求書番号")
            .gSubSetRow("NYUKINNO","入金番号")
            .gSubSetRow("HACCHUNO","発注番号")
            .gSubSetRow("SIRNO","仕入番号")
            .gSubSetRow("SHRNO","支払番号")
            .gSubSetRow("HOSHUYMD","保守点検作成年月")
            .gSubSetRow("HOSHUTANTCD","保守点検作成担当コード")
            .gSubSetRow("HOSHUJIKKOYMD", "保守点検作成実行日")
            .gSubSetRow("HOZONSAKINAME", "帳票CSV保存先名")
        End With
    End Sub
