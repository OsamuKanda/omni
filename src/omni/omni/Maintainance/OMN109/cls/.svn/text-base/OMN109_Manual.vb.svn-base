...
#Region "オーバーライドするメソッド"
    ...
    Protected Overrides Sub mSubSetDDL()
        ...
        ClsWebUIUtil.gSubInitDropDownList(SHANAIKBN, o.getDataSet("SHANAIKBN")) '社内区分マスタ
    ...
    Protected Overrides Sub mSubBtnAJSearch()
        ...
        With mprg.mwebIFDataTable        '検索
            ...
            Else
                '取得可否チェック
                With CType(mprg.gmodel, ClsOMN109).gcol_H
                    If .strDELKBN = "1" Then
                        '削除済み時
                        Select Case mGet更新区分()
                            Case em更新区分.新規
            ...
            '値を退避
            Dim oCopy_H As New ClsOMN109.ClsCol_H
            ClsChkStringUtil.gSubDeepCopy(oCopy_H, CType(mprg.gmodel, ClsOMN109).gcol_H)
            CType(mprg.gmodel, ClsOMN109).gcopy_H = oCopy_H
    ...
    Protected Overrides Sub mSubGetText()
        With CType(mprg.gmodel, ClsOMN109).gcol_H
            .strTANTCD = TANTCD.Text                                  '担当者コード

            .strTANTNM = TANTNM.Text                                  '担当者名
            .strSHANAIKBN = SHANAIKBN.SelectedValue.ToString          '社内区分
            .strKENGEN = KENGEN.Text                                  '権限
            .strPASSWORD = PASSWORD.Text                              'パスワード
            .strSYOZOKJIGYOCD = SYOZOKJIGYOCD.SelectedValue.ToString  '所属事業所コード
            .strUMUKBN = UMUKBN.SelectedValue.ToString                '作業担当有無
    ...
    Protected Overrides Sub mSubSetText()
        With CType(mprg.gmodel, ClsOMN109).gcol_H
            'TODO 個別修正箇所
            TANTCD.Text = .strTANTCD                                  '担当者コード

            TANTNM.Text = .strTANTNM                                  '担当者名
            SHANAIKBN.SelectedValue = ClsEditStringUtil.gStrConvSelectedValue(.strSHANAIKBN, SHANAIKBN)'社内区分
            KENGEN.Text = .strKENGEN                                  '権限
            PASSWORD.Text = .strPASSWORD                              'パスワード
            SYOZOKJIGYOCD.SelectedValue = ClsEditStringUtil.gStrConvSelectedValue(.strSYOZOKJIGYOCD, SYOZOKJIGYOCD)'所属事業所コード
            UMUKBN.SelectedValue = ClsEditStringUtil.gStrConvSelectedValue(.strUMUKBN, UMUKBN)'作業担当有無
    ...
    Protected Overrides Function mBlnChkInput(ByVal arrErrMsg As ClsErrorMessageList) As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN109)
...
#End Region
    ...
    Protected Overrides Sub mSubCreateWebIFData()
        ...
        With mprg.mwebIFDataTable
            .gSubAdd(TANTCD.ClientID,"TANTCD", 0, "numzero__6_", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(btnTANTCD.ClientID,"btnTANTCD", 0, "", "", "", "", "", "keyElm", "1", "0")
            .gSubAdd(btnSearch.ClientID,"btnSearch", 0, "", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(TANTNM.ClientID,"TANTNM", 0, "bytecount__16_", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(SHANAIKBN.ClientID,"SHANAIKBN", 0, "", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(KENGEN.ClientID,"KENGEN", 0, "han__1_", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(PASSWORD.ClientID,"PASSWORD", 0, "han__8_", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(SYOZOKJIGYOCD.ClientID,"SYOZOKJIGYOCD", 0, "", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(UMUKBN.ClientID, "UMUKBN", 0, "", "", "", "0", "", "mainElm", "1", "1")
