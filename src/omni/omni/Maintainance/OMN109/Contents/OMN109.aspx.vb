...
#Region "プライベートメソッド"
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            .gSubSetRow("TANTCD","担当者コード")
            .gSubSetRow("TANTNM","担当者名")
            .gSubSetRow("SHANAIKBN","社内区分")
            .gSubSetRow("KENGEN","権限")
            .gSubSetRow("PASSWORD","パスワード")
            .gSubSetRow("SYOZOKJIGYOCD","所属事業所コード")
            .gSubSetRow("UMUKBN","作業担当有無")
