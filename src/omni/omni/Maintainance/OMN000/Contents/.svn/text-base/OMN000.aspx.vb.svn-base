...
#Region "イベント"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            TANTNM.Text = mLoginInfo.userName
    ...
    Private Sub btnAJBefor_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAJBefor.Click
        Dim backURL As String = "../../../LoginMenu/Contents/MainMenu.aspx"
...
#Region "プライベートメソッド"
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            .gSubSetRow("PASSWORD","古いパスワード")
            .gSubSetRow("PASSWORD2","新しいパスワード")
            .gSubSetRow("PASSWORD3","新しいパスワードの確認")
        End With
    End Sub
