...
#Region "オーバーライドするメソッド"
    ...
    Protected Overrides Sub mSubBtnAJSearch()
        ...
        With mprg.mwebIFDataTable        '検索
            ...
            Else
                '取得可否チェック
                With CType(mprg.gmodel, ClsOMN117).gcol_H
                    If .strDELKBN = "1" Then
                        '削除済み時
                        Select Case mGet更新区分()
                            Case em更新区分.新規
            ...
            '値を退避
            Dim oCopy_H As New ClsOMN117.ClsCol_H
            ClsChkStringUtil.gSubDeepCopy(oCopy_H, CType(mprg.gmodel, ClsOMN117).gcol_H)
            CType(mprg.gmodel, ClsOMN117).gcopy_H = oCopy_H
    ...
    Protected Overrides Sub mSubGetText()
        With CType(mprg.gmodel, ClsOMN117).gcol_H
            .strHINCD = HINCD.Text                                    '品コード

            .strHINNM1 = HINNM1.Text                                  '品名１
            .strHINNM2 = HINNM2.Text                                  '品名２
            .strSURYO = SURYO.Text                                    '数量
    ...
    Protected Overrides Sub mSubSetText()
        With CType(mprg.gmodel, ClsOMN117).gcol_H
            'TODO 個別修正箇所
            HINCD.Text = .strHINCD                                    '品コード

            HINNM1.Text = .strHINNM1                                  '品名１
            HINNM2.Text = .strHINNM2                                  '品名２
            SURYO.Text = .strSURYO                                    '数量
    ...
    Protected Overrides Function mBlnChkInput(ByVal arrErrMsg As ClsErrorMessageList) As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN117)
    ...
    Protected Overrides Function mBln表示用にフォーマット() As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN117)
            With .gcol_H
            .strHINNM1 = .strHINNM1                                                       '品名１
            .strHINNM2 = .strHINNM2                                                       '品名２
            .strSURYO = ClsEditStringUtil.gStrFormatComma(.strSURYO)                      '数量
...
#End Region
    ...
    Protected Overrides Sub mSubCreateWebIFData()
        ...
        With mprg.mwebIFDataTable
            .gSubAdd(HINCD.ClientID,"HINCD", 0, "numzero__2_", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(btnHINCD.ClientID,"btnHINCD", 0, "", "", "", "", "", "keyElm", "1", "0")
            .gSubAdd(btnSearch.ClientID,"btnSearch", 0, "", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(HINNM1.ClientID, "HINNM1", 0, "!bytecount__40_", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(HINNM2.ClientID, "HINNM2", 0, "!bytecount__40_", "", "", "", "", "mainElm", "1", "1")
            .gSubAdd(SURYO.ClientID,"SURYO", 0, "!num__040001_", "", "", "", "", "mainElm", "1", "1")
