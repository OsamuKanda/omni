<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN114.aspx.vb" Inherits="omni.OMN1141" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN114" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltSAGYOTANTCD" CssClass="redTi lbltSAGYOTANTCD" runat="server" Text="作業担当者コード"></asp:Label>
						<asp:TextBox ID="SAGYOTANTCD" runat="server" Maxlength="4" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="SAGYOTANTCD" ></asp:TextBox>
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltSAGYOTANTNM" CssClass="redTi lbltSAGYOTANTNM" runat="server" Text="作業担当者名"></asp:Label>
								<asp:TextBox ID="SAGYOTANTNM" runat="server" Maxlength="16" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="SAGYOTANTNM" ></asp:TextBox>
								...
								<asp:UpdatePanel ID="udpRYAKUSHO" runat="server" UpdateMode="Conditional">
									<ContentTemplate>
										<asp:Button ID="btnAJRYAKUSHO" runat="server" TabIndex="-1" Text="AJ" UseSubmitBehavior="False" CssClass="ajaxbtm" />
										<asp:Label ID="RYAKUSHO" runat="server" Text=" " CssClass="lblAJCon RYAKUSHO"></asp:Label>
									</ContentTemplate>
								</asp:UpdatePanel>
							</asp:Panel>
						</div>
...
<asp:Content ID="headOMN114" runat="server" contentplaceholderid="head">
<link href="../css/OMN114.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN114.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	AJBtn.push(new Array("<%= btnAJRYAKUSHO.ClientID %>", "btnAJRYAKUSHO"));
	AJBtn.push(new Array("<%= btnAJModeCng.ClientID %>", "btnAJModeCng"));
