...
function ComBtmVeiw(bMode) {
	var i;
	if (bMode) {
		//document.getElementById(btnCom[0][0]).disabled = false;
		for(i=0;i<btnCom.length;i++){
			if (i == 0){
				//document.getElementById(btnCom[0][0]).disabled = false;
			}else{
				document.getElementById(btnCom[i][0]).disabled = false;
			}
		}
	} else {
		for(i=0;i<btnCom.length;i++){
			if (i == 0){
				//document.getElementById(btnCom[0][0]).disabled = true;
			}else{
				document.getElementById(btnCom[i][0]).disabled = true;
			}
		}
	}
}
