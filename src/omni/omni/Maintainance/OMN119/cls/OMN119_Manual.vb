...
#Region "オーバーライドするメソッド"
    ...
    Protected Overrides Sub mSubBtnAJSearch()
        ...
        With mprg.mwebIFDataTable        '検索
            ...
            Else
                '取得可否チェック
                With CType(mprg.gmodel, ClsOMN119).gcol_H
                    If .strDELKBN = "1" Then
                        '削除済み時
                        Select Case mGet更新区分()
                            Case em更新区分.新規
            ...
            '値を退避
            Dim oCopy_H As New ClsOMN119.ClsCol_H
            ClsChkStringUtil.gSubDeepCopy(oCopy_H, CType(mprg.gmodel, ClsOMN119).gcol_H)
            CType(mprg.gmodel, ClsOMN119).gcopy_H = oCopy_H
    ...
    Protected Overrides Sub mSubGetText()
        With CType(mprg.gmodel, ClsOMN119).gcol_H
            .strTANICD = TANICD.Text                                  '単位コード

            .strTANINM = TANINM.Text                                  '単位名称
    ...
    Protected Overrides Sub mSubSetText()
        With CType(mprg.gmodel, ClsOMN119).gcol_H
            'TODO 個別修正箇所
            TANICD.Text = .strTANICD                                  '単位コード

            TANINM.Text = .strTANINM                                  '単位名称
    ...
    Protected Overrides Function mBlnChkInput(ByVal arrErrMsg As ClsErrorMessageList) As Boolean
        ...
        With CType(mprg.gmodel, ClsOMN119)
...
#End Region
    ...
    Protected Overrides Sub mSubCreateWebIFData()
        ...
        With mprg.mwebIFDataTable
            .gSubAdd(TANICD.ClientID,"TANICD", 0, "numzero__2_", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(btnTANICD.ClientID,"btnTANICD", 0, "", "", "", "", "", "keyElm", "1", "0")
            .gSubAdd(btnSearch.ClientID,"btnSearch", 0, "", "", "", "", "", "keyElm", "1", "1")
            .gSubAdd(TANINM.ClientID,"TANINM", 0, "bytecount__4_", "", "", "", "", "mainElm", "1", "1")
