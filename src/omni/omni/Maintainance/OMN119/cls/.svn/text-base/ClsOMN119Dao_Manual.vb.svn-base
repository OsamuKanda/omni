...
Partial Public Class OMN119Dao(Of T)
    ''' <summary>
    ''' 追加用SQL取得
    ''' </summary>
    ''' <param name="o"></param>
    ...
    Public Overrides Function getSQLInsert(ByVal o As T) As String
        ...
        With mclsCol_H
            'SQL
            strSQL.Append(" INSERT INTO DM_TANI")
            strSQL.Append("(")
            strSQL.Append(" TANICD")                                            '単位コード
            strSQL.Append(",TANINM")                                            '単位名称
            ...
            strSQL.Append("," & ClsDbUtil.get文字列値(.strTANINM))              '単位名称
    ...
    Public Overrides Function getSQLDelete(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append(" WHERE DM_TANI.TANICD  = '" & .strTANICD & "'")                            '単位コード
    ...
    Public Overrides Function getSQLUpdate(ByVal o As T) As String
        ...
        With mclsCol_H
            Dim strSQL As New StringBuilder
            strSQL.Append("UPDATE DM_TANI")
            strSQL.Append("   SET TANINM          = " & ClsDbUtil.get文字列値(.strTANINM))             '単位名称
    ...
    Public Overrides Function getSQLSelect(ByVal o As T) As String
        With o.gcol_H
            ...
            strSQL.Append("  DM_TANI.TANICD AS TANICD ")
            strSQL.Append(", DM_TANI.TANINM AS TANINM ")

            strSQL.Append(", DM_TANI.DELKBN ")                                           '無効区分
            strSQL.Append(", DM_TANI.UDTTIME1 ")                                         '新規更新日時
            strSQL.Append(", DM_TANI.UDTUSER1 ")                                         '新規更新ユーザ
            strSQL.Append(", DM_TANI.UDTPG1 ")                                           '新規更新機能
            '抽出条件
            strSQL.Append("  FROM ")
            strSQL.Append("  DM_TANI ")                                                  'ヘッダ
            strSQL.Append("WHERE DM_TANI.TANICD   = '" & .strTANICD & "' ")                           '単位コード
            'If o.更新区分 <> em更新区分.新規 Then
            '    strSQL.Append("   AND DM_TANI.DELKBN ='0'")
            'End If
    ...
    Protected Overrides Sub setTableTo(ByVal dt As System.Data.DataTable, ByVal o As T)
        With o.gcol_H
            ...
            .strTANINM = r("TANINM").ToString               '単位名称
