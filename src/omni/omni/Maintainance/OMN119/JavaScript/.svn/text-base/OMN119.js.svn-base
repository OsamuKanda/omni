...
function TANICD_Search(e, str) {

	var url = "../../../Search/OMN823/Contents/OMN823.aspx";
	var mode = "Search";
	var nWidth = "300px";
	var nHeight = "567px";
	...
	// 規定値のフォーカスセット
	var elmNo = getElmNo('btnTANICD' + str);
	var elmNo2 = getElmNo('TANICD' + str);
	hidstrFocusSet(elmNo, elmNo2, '0');
