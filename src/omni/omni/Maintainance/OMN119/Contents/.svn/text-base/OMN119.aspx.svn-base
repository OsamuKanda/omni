<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN119.aspx.vb" Inherits="omni.OMN1191" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN119" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						...
						<asp:TextBox ID="TANICD" runat="server" Maxlength="2" onFocus="getFocus(this, 0)" onKeyDown="PushEnter()" onBlur="relFocus(this)" CssClass="TANICD" ></asp:TextBox>
						<asp:Button ID="btnTANICD" runat="server" TabIndex="-1" Text="検索" UseSubmitBehavior="False" onclientclick="return TANICD_Search(this,'');" CssClass="btnTANICD" />
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltTANINM" CssClass="redTi lbltTANINM" runat="server" Text="単位名称"></asp:Label>
...
<asp:Content ID="headOMN119" runat="server" contentplaceholderid="head">
<link href="../css/OMN119.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN119.js" type="text/javascript" ></script>
<script type="text/javascript" >
	...
	searchBtn.push(new Array("<%= btnTANICD.ClientID %>", "btnTANICD", "<%= TANICD.ClientID %>"));
