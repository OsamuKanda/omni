...
#Region "プライベートメソッド"
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            ...
            .gSubSetRow("SIRNM1","仕入先名１")
            .gSubSetRow("SIRNM2","仕入先名２")
            .gSubSetRow("SIRNMR","仕入先略称")
            .gSubSetRow("SIRNMX","仕入先カナ")
            .gSubSetRow("ZIPCODE","郵便番号")
            .gSubSetRow("ADD1","住所１")
            .gSubSetRow("ADD2","住所２")
            .gSubSetRow("TELNO","電話番号")
            .gSubSetRow("FAXNO","ＦＡＸ番号")
            .gSubSetRow("HASUKBN","端数区分（丸め区分）")
            .gSubSetRow("ZENZAN","前月残高")
            .gSubSetRow("TSIRKIN","当月仕入金額")
            .gSubSetRow("TSIRHENKIN","当月仕入返品金額")
            .gSubSetRow("TSIRNEBIKI","当月仕入値引金額")
            .gSubSetRow("TTAX","当月消費税")
            .gSubSetRow("TSHRGENKIN","当月支払現金")
            .gSubSetRow("TSHRTEGATA","当月支払手形")
            .gSubSetRow("TSHRNEBIKI","当月支払値引")
            .gSubSetRow("TSHRSOSAI","当月支払相殺")
            .gSubSetRow("TSHRSONOTA","当月支払その他")
            .gSubSetRow("TSHRANZENKAIHI","当月支払安全協力会費")
            .gSubSetRow("TSHRFURIKOMITESU","当月支払振込手数料")
        End With
    End Sub
