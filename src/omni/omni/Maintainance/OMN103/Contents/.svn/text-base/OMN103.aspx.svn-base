<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMN103.aspx.vb" Inherits="omni.OMN1031" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMN103" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divUPBtn" >
			<div class="divBtn" >
			...
			<ContentTemplate>
				<div class="divKey" >
					<asp:Panel ID="pnlKey" runat="server" >
						<asp:Label ID="lbltAREACD" CssClass="redTi lbltAREACD" runat="server" Text="地区コード"></asp:Label>
					...
					<ContentTemplate>
						...
						<div class="divMain" >
							<asp:Panel ID="pnlMain" runat="server" >
								<asp:Label ID="lbltAREANM" CssClass="redTi lbltAREANM" runat="server" Text="地区名"></asp:Label>
								...
								<asp:Label ID="lbltAREANMR" CssClass="blackTi lbltAREANMR" runat="server" Text="地区略称"></asp:Label>
...
<asp:Content ID="headOMN103" runat="server" contentplaceholderid="head">
<link href="../css/OMN103.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN103.js" type="text/javascript" ></script>
