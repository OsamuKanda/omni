  Partial Public Class OMN810Dao(Of T)
    '''*************************************************************************************
    ''' <summary>
    ''' データ取得
    ''' </summary>
    '''*************************************************************************************
    Public Function gBlnGetDataTable(ByVal o As ClsOMN810) As DataTable
    ...
    ''' </summary>
    '''*************************************************************************************
    Public Function gBlnGetDataCount(ByVal o As ClsOMN810) As Integer
        Dim ds As New DataSet
        Dim strSQL As New StringBuilder
    ...
    Private Function mStrOrder(ByVal o As ClsOMN810) As String
        Dim strSQL As New StringBuilder
        With o.gcol_H
            ...
            Else
                ...
                Select Case o.sort
                    Case "DM_BBUNRUI.BBUNRUICD", "DM_BBUNRUI.BBUNRUICD DESC"
                        strSQL.Append(o.sort & ", DM_BBUNRUI.BBUNRUINM ")
                    Case "DM_BBUNRUI.BBUNRUINM", "DM_BBUNRUI.BBUNRUINM DESC"
                        strSQL.Append(o.sort & ", DM_BBUNRUI.BBUNRUICD ")
                End Select
    ...
    Private Function mStrWhere(ByVal o As ClsOMN810) As String
        Dim strSQL As New StringBuilder
        With o.gcol_H
