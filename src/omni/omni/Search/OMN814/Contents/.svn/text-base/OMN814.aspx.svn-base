<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/search.Master" CodeBehind="OMN814.aspx.vb" Inherits="omni.OMN8141" %>
<%@ MasterType VirtualPath="~/Master/search.Master" %>
<asp:Content ID="mainOMN814" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<div class="divKey" >
			...
			<ContentTemplate>
				...
				<div class="LVContent" >
					<asp:ObjectDataSource ID="ODSSearch"
					  Runat="server" TypeName="omni.OMN814_DAL"
					  SortParameterName="SortExpression"
					  SelectMethod="GetOMN814_List" 
					  SelectCountMethod="GetOMN814_ListCount"
					  EnablePaging="True">
					    <SelectParameters>
...
<asp:Content ID="headOMN814" runat="server" contentplaceholderid="head">
<link href="../css/OMN814.css" rel="stylesheet" type="text/css" />
...
<script src="../JavaScript/OMN814.js" type="text/javascript" ></script>
