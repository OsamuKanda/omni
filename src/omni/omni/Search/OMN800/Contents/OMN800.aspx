<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/search.Master" CodeBehind="OMN800.aspx.vb" Inherits="omni.OMN8001" %>
<%@ MasterType VirtualPath="~/Master/search.Master" %>
<asp:Content ID="mainOMN800" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<hr />
		<div class="divKey" >
			...
			<ContentTemplate>
				...
				<div class="LVContent" >
					<asp:ObjectDataSource ID="ODSSearch"
					  Runat="server" TypeName="omni.OMN800_DAL"
					  SortParameterName="SortExpression"
					  SelectMethod="GetOMN800_List" 
					  SelectCountMethod="GetOMN800_ListCount"
					  EnablePaging="True">
					    <SelectParameters>
									...
									<asp:TemplatePagerField>
										<PagerTemplate>
											<div class="DPPage">
                                                ...
                                                ／
												<asp:Label ID="lblTotalPage" runat="server" Text="<%# Math.Ceiling(CDbl(Container.TotalRowCount) / Container.PageSize) %>" />
                                                頁
											</div>
										</PagerTemplate>
								</asp:TemplatePagerField>
								...
								<thead class="LVthedder" >
									<tr >
										<th class="CellNONYUCD" >
											<asp:LinkButton ID="linkNONYUCD" runat="server" Text="納入先コード" CommandName="Sort" CommandArgument="DM_NONYU.NONYUCD" CssClass="link" />
...
<asp:Content ID="headOMN800" runat="server" contentplaceholderid="head">
<link href="../css/OMN800.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN800.js" type="text/javascript" ></script>
