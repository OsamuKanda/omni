<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/search.Master" CodeBehind="OMN805.aspx.vb" Inherits="omni.OMN8051" %>
<%@ MasterType VirtualPath="~/Master/search.Master" %>
<asp:Content ID="mainOMN805" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<hr />
		<div class="divKey" >
			<asp:Panel ID="pnlKey" runat="server" >
				...
				<asp:Label ID="lbltTANTNM" CssClass="blackTi lbltTANTNM" runat="server" Text="担当者名"></asp:Label>
			...
			<ContentTemplate>
				...
				<div class="LVContent" >
					<asp:ObjectDataSource ID="ODSSearch"
					  Runat="server" TypeName="omni.OMN805_DAL"
					  SortParameterName="SortExpression"
					  SelectMethod="GetOMN805_List" 
					  SelectCountMethod="GetOMN805_ListCount"
					  EnablePaging="True">
					    <SelectParameters>
					      <asp:ControlParameter ControlID="SYOZOKJIGYOCD" Name="SYOZOKJIGYOCD" PropertyName="SelectedValue" />
					      <asp:ControlParameter ControlID="SHANAIKBN" Name="SHANAIKBN" PropertyName="SelectedValue" />
						...
						<LayoutTemplate>
							<table id="LV" cellspacing="0" cellpadding="0" rules="cols" class="LVTable" >
								<thead class="LVthedder" >
									<tr >
										<th class="CellTANTCD" >
											<asp:LinkButton ID="linkTANTCD" runat="server" Text="担当者コード" CommandName="Sort" CommandArgument="DM_TANT.TANTCD" CssClass="link" />
											<asp:Label ID="SortByTANTCD" runat="server" Text="▲"></asp:Label>
										</th>
										<th class="CellTANTNM" >
											<asp:LinkButton ID="linkTANTNM" runat="server" Text="担当者名" CommandName="Sort" CommandArgument="DM_TANT.TANTNM" CssClass="link" />
...
<asp:Content ID="headOMN805" runat="server" contentplaceholderid="head">
<link href="../css/OMN805.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../../../JavaScript/common.js" type="text/javascript" ></script>
<script src="../../../JavaScript/Validator.js" type="text/javascript" ></script>
<script src="../JavaScript/OMN805.js" type="text/javascript" ></script>
