...
#Region "イベント"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            End With
            SYOZOKJIGYOCD.SelectedValue = ClsEditStringUtil.gStrConvSelectedValue(mLoginInfo.EIGCD, SYOZOKJIGYOCD)
            SHANAIKBN.SelectedValue = ClsEditStringUtil.gStrConvSelectedValue("0", SHANAIKBN)
        Else
            'Master.strclicom = ""
        End If
    End Sub
    ...
    Protected Sub Search_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Search.Click
        ...
        Me.ODSSearch.Select()
        LVSearch.Sort("DM_TANT.TANTCD", SortDirection.Ascending)
    End Sub
    ...
    Protected Sub LVSearch_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewItemEventArgs) Handles LVSearch.ItemDataBound
        If e.Item.ItemType = ListViewItemType.DataItem Then
            ...
            trItem1.Attributes("OnClick") = "ret(this,[""" & row("TANTCD") & """])"
          End If
      End Sub
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            .gSubSetRow("SYOZOKJIGYOCD", "事業所")
            .gSubSetRow("SHANAIKBN", "社内区分")
            .gSubSetRow("TANTNM","担当者名")
        End With
    End Sub
