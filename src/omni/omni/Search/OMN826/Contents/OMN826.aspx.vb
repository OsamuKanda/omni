...
#Region "イベント"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Master.title = "報告書分類検索"
            LVSearch.DataSourceID = Nothing
            mprg.gmodel = New ClsOMN826
            'mSubSearch()
    ...
    Protected Sub Search_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Search.Click
        ...
        Me.ODSSearch.Select()
        LVSearch.Sort("DM_HBUNRUI.HBUNRUICD", SortDirection.Ascending)
    End Sub
    ...
    Protected Sub LVSearch_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewItemEventArgs) Handles LVSearch.ItemDataBound
        If e.Item.ItemType = ListViewItemType.DataItem Then
            ...
            trItem1.Attributes("OnClick") = "ret(this,[""" & row("HBUNRUICD") & """])"
          End If
      End Sub
