Partial Public Class OMN806Dao(Of T)
    '''*************************************************************************************
    ''' <summary>
    ''' データ取得
    ''' </summary>
    '''*************************************************************************************
    Public Function gBlnGetDataTable(ByVal o As ClsOMN806) As DataTable
    ...
    ''' </summary>
    '''*************************************************************************************
    Public Function gBlnGetDataCount(ByVal o As ClsOMN806) As Integer
        Dim ds As New DataSet
        Dim strSQL As New StringBuilder
    ...
    Private Function mStrOrder(ByVal o As ClsOMN806) As String
        Dim strSQL As New StringBuilder
        With o.gcol_H
    ...
    Private Function mStrWhere(ByVal o As ClsOMN806) As String
        Dim strSQL As New StringBuilder
        With o.gcol_H
