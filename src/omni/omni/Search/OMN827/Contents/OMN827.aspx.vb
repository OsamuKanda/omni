...
#Region "イベント"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not ClsChkStringUtil.gSubChkInputString("numzero__7_", SEIKYUSHONO.Text, "") Then
                blnFlg = False
            End If
            If blnFlg And SEIKYUSHONO.Text <> "" Then
    ...
    Protected Sub LVSearch_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewItemEventArgs) Handles LVSearch.ItemDataBound
        If e.Item.ItemType = ListViewItemType.DataItem Then
            ...
            trItem1.Attributes("OnClick") = "ret(this,[""" & row("SEIKYUSHONO") & """, """ & row("NYUKINNO") & """])"
          End If
      End Sub
    ...
    Private Sub mSub項目名テーブル生成()
        With mprg.mcstrJPNName
            ...
            .gSubSetRow("NYUKINYMD","入金日付")
            .gSubSetRow("INPUTCD","入力者コード")
        End With
    End Sub
