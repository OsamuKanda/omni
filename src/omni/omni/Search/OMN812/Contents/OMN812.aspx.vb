...
#Region "イベント"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Master.title = "納入先別号機検索"
            LVSearch.DataSourceID = Nothing
            mprg.gmodel = New ClsOMN812
            'mSubSearch()
            'ドロップダウンリストの値セット
            mSubSetDDL()
            ...
            With mprg.mwebIFDataTable
                ...
                Dim jigyo As String
                NONYUCD.Text = Request.QueryString("NONYUCD")
                jigyo = Request.QueryString("JIGYOCD")
                Dim disable As String = Request.QueryString("disable")
                If NONYUCD.Text <> "" Then
                    NONYU = mmClsGetNONYU(jigyo, NONYUCD.Text, "01")
                    NONYUNM1.Text = NONYU.strNONYUNM1
                End If
                NONYUCD.Focus()
                If disable = "true" Then
                    If NONYU.IsSuccess = False Then
                        Master.errMsg = "result=1__納入先マスタにデータがない為、抽出できません。"
                    End If
    ...
    Protected Sub Search_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Search.Click
        ...
        Me.ODSSearch.Select()
        LVSearch.Sort("DM_HOSHU.NONYUCD", SortDirection.Ascending)
    End Sub
    ...
    Protected Sub LVSearch_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewItemEventArgs) Handles LVSearch.ItemDataBound
        If e.Item.ItemType = ListViewItemType.DataItem Then
            ...
            trItem1.Attributes("OnClick") = "ret(this,[""" & row("NONYUCD") & """,""" & row("GOUKI") & """])"
            Dim o2 = e.Item.FindControl("trIT2")
            Dim trItem2 As HtmlTableRow = CType(o2, HtmlTableRow)
            trItem2.Attributes("OnClick") = "ret(this,[""" & row("NONYUCD") & """,""" & row("GOUKI") & """])"
          End If
      End Sub
