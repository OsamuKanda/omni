<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMB003.aspx.vb" Inherits="omni.OMB0031" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMB003" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
		<asp:UpdatePanel ID="udpBatch" runat="server" UpdateMode="Conditional">
			<ContentTemplate>
				<div id="HeadMsg" runat="server" class="divHeadMsg" ></div>
				<div id="Message" runat="server" class="divMessage" ></div>
...
<link href="../css/OMB003.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMB003.js" type="text/javascript" ></script>
