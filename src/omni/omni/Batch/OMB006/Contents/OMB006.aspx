<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/omni.Master" CodeBehind="OMB006.aspx.vb" Inherits="omni.OMB0061" %>
<%@ MasterType VirtualPath="~/Master/omni.Master" %>
<asp:Content ID="mainOMB006" ContentPlaceHolderID="Main" runat="server" >
	<div id="pageContent" >
...
<link href="../css/OMB006.css" rel="stylesheet" type="text/css" />
<link href="../../../css/ComCss.css" rel="stylesheet" type="text/css" />
<script src="../JavaScript/OMB006.js" type="text/javascript" ></script>
