...
#Region "イベント"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            mprg.gmodel = New ClsOMN613
            'mSubSearch()
            With CType(mprg.gmodel, ClsOMN613).gcol_H
                .strSEIKYUSHONO = Request.QueryString("SEIKYUSHONO")
    ...
    Protected Sub Excel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAJExcel.Click
        If LVSearch.DataSourceID <> "" Then
            ...
            sw.WriteLine("適用,数量,単位,単価,金額")
        
            Dim o As New ClsOMN613
            o.gcol_H.strJIGYOCD = JIGYOCD.Text
            o.gcol_H.strSEIKYUSHONO = SEIKYUSHONO.Text
            o.isPager = True
            o.maximumRows = 1000
    ...
    Protected Sub LVSearch_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewItemEventArgs) Handles LVSearch.ItemDataBound
        If e.Item.ItemType = ListViewItemType.DataItem Then
            ...
            If row("SURYO").ToString = "0.00" Then
                Dim suryo = CType(e.Item.FindControl("SURYO"), Label)
                suryo.Text = ""
            End If
            If row("TANKA").ToString = "0.00" Then
                Dim tank = CType(e.Item.FindControl("TANKA"), Label)
                tank.Text = ""
            End If
            If row("GOUKING").ToString = "0" Then
                Dim king = CType(e.Item.FindControl("GOUKING"), Label)
                king.Text = ""
            End If
