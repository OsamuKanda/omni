...
function AJCon(strID, nNowID) {
	...
	switch (strAJ) {
  		...
  		case "btnAJGINKONMFROM2":
		case "btnAJGINKONMTO2":
			bRet = btnAJOne(strAJ);
			break;
...
function GINKOCD_Search(e, str, strmode) {
	...
	var elmNo2;
	if (strmode == 'FROM') {
	    elmNo = getElmNo('GINKOCDTO2' + str);
	    elmNo2 = getElmNo('GINKOCDFROM2' + str);
	} else {
	    elmNo = getElmNo('btnSearch' + str);
	    elmNo2 = getElmNo('GINKOCDTO2' + str);
	}
	hidstrFocusSet(elmNo, elmNo2, '0');
	...
	if (retval != null) {
	    if (str == "FROM2") {
	        if (btnAJOne('btnAJGINKONMFROM2') == false) {
	            elm.focus();
	        }
	    } else {
	        if (btnAJOne('btnAJGINKONMTO2') == false) {
	            elm.focus();
	        }
	    }
	} else {
