var _nc_ttwproi111129_params = (function() {
	var result = {};
	var crossdomain;
...
var _nc_ttwproi111129_clicked = function (url) {
	new Image().src = 'http://connect.newzia.jp/channels/182/clicked'
		+ '?url=' + encodeURIComponent(url)
		+ '&page_url=' + encodeURIComponent(_nc_ttwproi111129_params.url)
		+ '&ref=' + encodeURIComponent(_nc_ttwproi111129_params.referrer)
		+ '&' + Math.random();
}
;
var _nc_ttwproi111129_callback = function (response) {
	var params = _nc_ttwproi111129_params;
	(function (contents_length) {
	new Image().src = 'http://connect.newzia.jp/channels/182/viewed'
		+ '?url=' + encodeURIComponent(_nc_ttwproi111129_params.url)
		+ '&ref=' + encodeURIComponent(_nc_ttwproi111129_params.referrer)
		+ '&contents_length=' + contents_length
		+ '&' + Math.random();
}
)(response.length);
	var newziaConnect = document.getElementById('newzia_connect_ttwproi111129');
var getMedianamettwproi111129 = function() {
...
var ttwproi111129temp = '';
ttwproi111129temp += "<div id=\"newzia_connect_ttwproi111129\" class=\"btmlist newziaConnectAPI\"><ul>";

for (i = 0; i < response.length; i++) {
	ttwproi111129temp += "<li><a onclick=\"var s=s_gi('itmediacojpglobal'); s.eVar21='" + getMedianamettwproi111129() + "'; s.tl(this,'o','" + getMedianamettwproi111129() +"');\" href=\"" + response[i].url + "\" ontouchstart=\"_nc_ttwproi111129_clicked(this.href)\" onmousedown=\"_nc_ttwproi111129_clicked(this.href)\">" + response[i].title + "</a></li>";
}

ttwproi111129temp += "</ul></div>";
newziaConnect.innerHTML = ttwproi111129temp;
...
(function () {
	...
	var callNewziaConnect = function () {
		...
		script.src = 'http://connect.newzia.jp/channels/182/' + params.digest + '/contents.json?'
	...
	if (!document.getElementById('newzia_connect_ttwproi111129')) {
		document.write('<div id="newzia_connect_ttwproi111129"></div>');
