...
--OMP708 事業所別売上一覧表
-------------------------------------------------------------------------------
CREATE OR REPLACE VIEW V_OMP708_1
AS
SELECT
              ROWNUM  AS EDANUM
		...
		FROM 
			-- 全て
			(  SELECT DT_BUKKEN.JIGYOCD							--事業所コード
            ...
            AND		D0.JIGYOCD	=	DM_JIGYO.JIGYOCD
             		-- 管理マスタ
